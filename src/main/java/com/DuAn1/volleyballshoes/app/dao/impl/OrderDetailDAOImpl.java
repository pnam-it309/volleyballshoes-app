...
public class OrderDetailDAOImpl implements OrderDetailDAO {
    ...
    public List<OrderDetail> saveAll(List<OrderDetail> orderDetailList) {
        String sql = "INSERT INTO OrderDetail (order_id, variant_id, detail_quantity, detail_unit_price) "
                + "VALUES (?, ?, ?, ?)";
        ...
        for (OrderDetail detail : orderDetailList) {
            ...
            String idSql = "SELECT IDENT_CURRENT('OrderDetail')";
    ...
    public OrderDetail save(OrderDetail orderDetail) {
        ...
        if (orderDetail.getOrderDetailId() <= 0) {
            ...
            // Cập nhật
            String sql = "UPDATE OrderDetail SET order_id = ?, variant_id = ?, "
                    + "detail_quantity = ?, detail_unit_price = ? WHERE order_detail_id = ?";
