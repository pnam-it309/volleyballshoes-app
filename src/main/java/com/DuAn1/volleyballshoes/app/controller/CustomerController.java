...
public class CustomerController {
     ...
     * @throws IllegalArgumentException If the request is invalid or a customer with the same code/phone/email exists
     */
    public Customer createCustomer(CustomerCreateRequest request) {
        ...
        if (request.getCustomerPhone() != null && !request.getCustomerPhone().trim().isEmpty() && 
            customerDAO.findByPhone(request.getCustomerPhone()) != null) {
     ...
     * @throws IllegalArgumentException If the customer ID is invalid or the customer doesn't exist
     */
     ...
     * @throws IllegalArgumentException If the customer code is invalid or the customer doesn't exist
     */
    ...
    /**
     * Searches for customers by gender.
     * 
     * @param gender The gender to filter by (MALE, FEMALE, OTHER)
     * @return A list of customers with the specified gender
     */
    public List<Customer> getCustomersByGender(Gender gender) {
        ...
        return customerDAO.findAll().stream()
            .filter(c -> gender.equals(c.getCustomerGender()))
     ...
     * @param points The new points value (must be non-negative)
     * @throws IllegalArgumentException If the customer ID is invalid, the customer doesn't exist, or points are negative
     */
    public void updateCustomerPoints(Integer customerId, int points) {
        if (points < 0) {
